...
import 'package:samaware_flutter/modules/PriceSetter/PriceSetterOrderDetails/PriceSetterOrderItemsDetails.dart';
import 'package:samaware_flutter/shared/components/Imports/default_imports.dart';

class PriceSetterOrderDetails extends StatefulWidget {
  OrderModel order;
  PriceSetterOrderDetails({super.key, required this.order});

  @override
  State<PriceSetterOrderDetails> createState() => _PriceSetterOrderDetailsState();
}

class _PriceSetterOrderDetailsState extends State<PriceSetterOrderDetails> {
                      ...
                      child: Column(
                        ...
                        [
                          ...
                          defaultButton(
                              ...
                              onTap: ()
                              {
                                navigateTo(context, PriceSetterOrderItemsDetails(order: widget.order,));
                              }
                          ),
