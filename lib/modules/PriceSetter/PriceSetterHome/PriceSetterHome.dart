...
import 'package:samaware_flutter/modules/PriceSetter/PriceSetterPrepareOrder/PriceSetterPrepareOrder.dart';
import 'package:samaware_flutter/shared/components/Imports/default_imports.dart';
import 'package:string_extensions/string_extensions.dart';

class PriceSetterHome extends StatefulWidget {
  const PriceSetterHome({super.key});

  @override
  State<PriceSetterHome> createState() => _PriceSetterHomeState();
}

class _PriceSetterHomeState extends State<PriceSetterHome> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit,AppStates>(
      ...
      builder: (context,state)
      {
        ...
        var orders = cubit.priceSetterWaitingOrders;
                                    ...
                                    itemBuilder: (context,index)
                                    {
                                      return defaultBox(
                                          ...
                                          onTap: ()
                                          {
                                            ...
                                            navigateTo(context, PriceSetterPrepareOrder(orderId:  orders.orders![index].orderId!,));
                                          },
