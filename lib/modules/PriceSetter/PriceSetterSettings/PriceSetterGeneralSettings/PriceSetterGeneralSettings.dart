...
class PriceSetterGeneralSettings extends StatefulWidget {

  const PriceSetterGeneralSettings({super.key});

  @override
  State<PriceSetterGeneralSettings> createState() => _PriceSetterGeneralSettingsState();
}

class _PriceSetterGeneralSettingsState extends State<PriceSetterGeneralSettings> {
