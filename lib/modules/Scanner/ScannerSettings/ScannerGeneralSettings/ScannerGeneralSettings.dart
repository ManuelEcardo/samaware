...
class ScannerGeneralSettings extends StatefulWidget {
  const ScannerGeneralSettings({super.key});

  @override
  State<ScannerGeneralSettings> createState() => _ScannerGeneralSettingsState();
}

class _ScannerGeneralSettingsState extends State<ScannerGeneralSettings> {
