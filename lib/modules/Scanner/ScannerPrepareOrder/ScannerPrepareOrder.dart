          ...
          child: Scaffold(
            ...
            body: OrientationBuilder(
              builder: (context,orientation)
              {
                ...
                {
                  if(order?.status == OrderState.collected.name)
                  {
    ...
    timer = Timer.periodic(const Duration(seconds: 1), (Timer t)
    {
      setState(()
      {
        try {
          ...
          if(passedDate ==null)
          {
            passedTime= durationFormatToHMS(date.difference(defaultDateFormatter.parse(cubit.inWorkingOrder!.beingScannedDate!)));
