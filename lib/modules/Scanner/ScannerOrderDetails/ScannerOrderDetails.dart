...
import 'package:samaware_flutter/modules/Scanner/ScannerOrderDetails/ScannerOrderItemsDetails.dart';
import 'package:samaware_flutter/shared/components/Imports/default_imports.dart';

class ScannerOrderDetails extends StatefulWidget {
  OrderModel order;
  ScannerOrderDetails({super.key, required this.order});

  @override
  State<ScannerOrderDetails> createState() => _ScannerOrderDetailsState();
}

class _ScannerOrderDetailsState extends State<ScannerOrderDetails> {
                      ...
                      child: Column(
                        ...
                        [
                          ...
                          defaultButton(
                              ...
                              onTap: ()
                              {
                                navigateTo(context, ScannerOrderItemsDetails(order: widget.order,));
                              }
                          ),
