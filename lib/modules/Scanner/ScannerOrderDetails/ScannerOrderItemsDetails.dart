...
class ScannerOrderItemsDetails extends StatefulWidget {
  OrderModel order;
  ScannerOrderItemsDetails({super.key, required this.order});

  @override
  State<ScannerOrderItemsDetails> createState() => _ScannerOrderItemsDetailsState();
}

class _ScannerOrderItemsDetailsState extends State<ScannerOrderItemsDetails> {
