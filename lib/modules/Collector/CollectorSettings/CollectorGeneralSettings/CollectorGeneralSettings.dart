...
class CollectorGeneralSettings extends StatefulWidget {
  const CollectorGeneralSettings({super.key});

  @override
  State<CollectorGeneralSettings> createState() => _CollectorGeneralSettingsState();
}

class _CollectorGeneralSettingsState extends State<CollectorGeneralSettings> {
