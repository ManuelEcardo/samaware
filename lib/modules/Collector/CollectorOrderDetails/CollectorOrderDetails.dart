...
import 'package:samaware_flutter/modules/Collector/CollectorOrderDetails/CollectorOrderItemsDetails.dart';
import 'package:samaware_flutter/modules/Manager/ManagerOrderDetails/ManagerOrderDetails.dart';
import 'package:samaware_flutter/shared/components/Imports/default_imports.dart';

class CollectorOrderDetails extends StatefulWidget {
  OrderModel order;
  CollectorOrderDetails({super.key, required this.order});

  @override
  State<CollectorOrderDetails> createState() => _CollectorOrderDetailsState();
}

class _CollectorOrderDetailsState extends State<CollectorOrderDetails> {
                      ...
                      child: Column(
                        ...
                        [
                          ...
                          defaultButton(
                              ...
                              onTap: ()
                              {
                                navigateTo(context, CollectorOrderItemsDetails(order: widget.order,));
                              }
                          ),
