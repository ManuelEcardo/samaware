...
class CollectorOrderItemsDetails extends StatefulWidget {
  OrderModel order;
  CollectorOrderItemsDetails({super.key, required this.order});

  @override
  State<CollectorOrderItemsDetails> createState() => _CollectorOrderItemsDetailsState();
}

class _CollectorOrderItemsDetailsState extends State<CollectorOrderItemsDetails> {
