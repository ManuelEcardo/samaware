...
class WorkerGeneralSettings extends StatefulWidget {
  const WorkerGeneralSettings({super.key});

  @override
  State<WorkerGeneralSettings> createState() => _WorkerGeneralSettingsState();
}

class _WorkerGeneralSettingsState extends State<WorkerGeneralSettings> {
