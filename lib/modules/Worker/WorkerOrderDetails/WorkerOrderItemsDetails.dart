...
class WorkerOrderItemsDetails extends StatefulWidget {
  OrderModel order;

  WorkerOrderItemsDetails({super.key, required this.order});

  @override
  State<WorkerOrderItemsDetails> createState() => _WorkerOrderItemsDetailsState();
}

class _WorkerOrderItemsDetailsState extends State<WorkerOrderItemsDetails> {
