...
class ManagerOrderItemsDetails extends StatefulWidget {
  OrderModel order;
  ManagerOrderItemsDetails({super.key, required this.order});

  @override
  State<ManagerOrderItemsDetails> createState() => _ManagerOrderItemsDetailsState();
}

class _ManagerOrderItemsDetailsState extends State<ManagerOrderItemsDetails> {
